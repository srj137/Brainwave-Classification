# -*- coding: utf-8 -*-
"""
Created on Thu Mar 21 20:03:38 2019
...
net_name='CNN2D'
#Load Data
X, y= data_loading.get_2Ddata(data_name,data_type)
# Encoding labels
...
model.fit(X_train, y_train, batch_size = batch_size, epochs =no_epochs, verbose=2, validation_split=0.1, callbacks=callbacks)
